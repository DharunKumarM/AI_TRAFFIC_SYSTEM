...
try:
    ...
    print("RPi.GPIO module not found. Running in mock mode.")
...
cam=cv2.VideoCapture(r'E:\Github local file\AI_TRAFFIC_SYSTEM\4K Road traffic video for object detection and tracking - free download now!.mp4')
